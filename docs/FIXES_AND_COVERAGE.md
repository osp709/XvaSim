...
### Current Snapshot (measured 2026-09-09)

- Total statements: 3,012; covered: 2,974; missing: 38.
- **Overall coverage: 98.0%** (requirement: `fail_under = 95.0`).
...
| `xvasim/cva_engine.py` | 98.5% | 384, 873; branch 914->916 |
...
| `xvasim/pricing_engine.py` | 96.4% | 205, 211, 294-295, 992-995, 1244-1249, 1270-1278, 1799-1810 |
| `xvasim/qmc.py` | 99.0% | branch 585->588; 622 |
| `xvasim/utils.py` | 100.0% | — |
| **TOTAL** | **98.0%** | **38 statements** |
...
- `xvasim/cva_engine.py` (98.5%) — empty-array guard (`384`) and numexpr-unavailable fallback branch (`873`).
