...
class TestLGMCalibrationEngine(unittest.TestCase):
    ...
    def test_lgm_swaption_price_normal_zero_kappa(self) -> None:
        ...
        model_p, mkt_p = _swaption_price_normal(
            expiry_yrs=1.0,
            swap_tenor_yrs=5.0,
    ...
    def test_lgm_model_swaption_price_normal(self) -> None:
        """Verify LGMModel.swaption_price_normal method."""
        lgm = LGMModel(
            kappa_ann=0.03,
    ...
    def test_calibrate_ir_model_to_swaptions(self) -> None:
        """Verify calibrate_ir_model_to_swaptions bootstrap calibration."""
    ...
    def test_calibrate_ir_model_failure_raises(self) -> None:
